...
export const stepsController = {
  async getRecordForDate(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      const record = await stepsModel.getRecordForDate(date as string | undefined);
  ...
  async getById(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const { id } = req.params;
      const record = await stepsModel.findById(id);
  ...
  async create(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      const record = await stepsModel.create({ date, steps, goal, distanceKm, caloriesBurned });
  ...
  async addSteps(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      const record = await stepsModel.addSteps(steps);
  ...
  async update(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      const record = await stepsModel.update(id, updateData);
      if (!record) return next(new NotFoundError('Step record'));
  ...
  async delete(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const { id } = req.params;
      const deleted = await stepsModel.delete(id);
  ...
  async getStats(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const stats = await stepsModel.getStats();
  ...
  async getHistory(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const history = await stepsModel.getLast7Days();
  ...
  async updateGoal(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      const goal = await stepsModel.updateGoal({ dailyGoal });
