...
export const meditationController = {
  async getSessionsForDate(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      const sessions = await meditationModel.getSessionsForDate(date as string | undefined);
  ...
  async getById(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const { id } = req.params;
      const session = await meditationModel.findById(id);
  ...
  async create(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      const session = await meditationModel.create({ type, startTime, durationMinutes, isCompleted, notes });
  ...
  async update(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      const session = await meditationModel.update(id, updateData);
      if (!session) return next(new NotFoundError('Meditation session'));
  ...
  async markComplete(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const { id } = req.params;
      const session = await meditationModel.markComplete(id);
      if (!session) return next(new NotFoundError('Meditation session'));
  ...
  async delete(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const { id } = req.params;
      const deleted = await meditationModel.delete(id);
  ...
  async getStats(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const stats = await meditationModel.getStats();
  ...
  async getHistory(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const history = await meditationModel.getLast7Days();
  ...
  async getGoal(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const goal = await meditationModel.getGoal();
  ...
  async updateGoal(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      const goal = await meditationModel.updateGoal({ dailyMinutesGoal, weeklySessionsGoal });
